...
// TODO: make this generate expressions instead of nodes

// ParseTokenStream takes a token stream and converts it into an AST. This AST can then be interpreted into an actual model.
